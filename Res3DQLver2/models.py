...
class DuelingDQNetwork(nn.Module):
    def __init__(self, state_size, action_size, num_frames=2):
        ...
        # Residual blocks
        self.layer1 = ResidualBlock(num_frames, 32)
...
class DuelingDQNAgent:
    def __init__(self, logger):
        ...
        self.model = DuelingDQNetwork(self.state_size, self.action_size, num_frames=2).to(self.device)
        self.target_model = DuelingDQNetwork(self.state_size, self.action_size, num_frames=2).to(self.device)
